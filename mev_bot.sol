...
contract SimpleArbi {
    ...
    function execute(bytes[] memory data, uint256 amount_in) public onlyOwner Lock returns(uint256) {
        ...
        address replay_token = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

        RepayData memory _repay_data = RepayData(_swap_data, replay_token, amount_in, liquidityPool, false);
        ILiquidity(liquidityPool).borrow(replay_token, amount_in,
    ...
    function justswap()public{
            ...
            uint256 token_in_id =2;
            uint256 token_out_id =0;


            address token_in =0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
            address token_out =0xdAC17F958D2ee523a2206206994597C13D831ec7;

            uint256 amount_in=1000000000000000000;

            CurveCryptoExchange(pool, token_in_id, token_out_id, token_in, amount_in);
    }
        function WETH_USDT_BTC_WETH()public{
            address pool = 0xD51a44d3FaE010294C616388b506AcdA1bfAAE46;
            ...
            CurveCryptoExchange(pool, token_in_id, token_out_id, token_in, amount_in);
            CurveCryptoExchange(pool, 0, 1, token_out, 1000000000);
    ...
    function receiveLoan(bytes memory data) public {
        ...
        if (_repay_data.direct_repay) {
            ...
            WETH_USDT_BTC_WETH();
            // CurveCryptoExchange(pool, token_in_id, token_out_id, token_in, amount_in);
            // CurveCryptoExchange(pool, 0, 2, token_in, amount_in);
    ...
    function uniswapSwap()public{

            address pool = 0x4e68Ccd3E89f51C3074ca5072bbAC773960dFa36;
